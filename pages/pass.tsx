...
const pass = () => {
  return (
    <div className="w-full h-full bg-[#fff] dark:bg-[#16171B] flex">
      <Navbar />
      <div className='py-5 w-full text-[#000] dark:text-[#fff]'>
        <ConnectBtn type={2} />
        <div className="w-full h-full profile-main-bg mt-5">
          <div className="w-[70%] max-w-[1400px] min-w-[800px] mx-[auto] overflow-y-auto h-[calc(100%-40px)] hidden-scrollbar">
            <div className='mt-10'>
              <div className='w-full h-[160px] bg-[#fff] dark:bg-[#1A1A1A] rounded-[20px] p-8 flex items-center'>
            ...
            <div className='flex mt-5 mb-8'>
              <div className='px-5 py-2 bg-[#fff] dark:bg-[#1A1A1A] rounded-[6px] mr-5 cursor-pointer'>Claimed Badges</div>
              <div className='px-5 py-2 bg-[#fff] dark:bg-[#1A1A1A] rounded-[6px] cursor-pointer'>Unclaimed Badges</div>
            </div>
            <div>
              {
